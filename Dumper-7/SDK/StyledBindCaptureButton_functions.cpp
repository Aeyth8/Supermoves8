...
void UStyledBindCaptureButton_C::OnPromptClosed(bool bWasCancelled)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("StyledBindCaptureButton_C", "OnPromptClosed");

	Params::StyledBindCaptureButton_C_OnPromptClosed Parms{};
