...
public:
	...
	void OnPromptClosed(bool bWasCancelled);
...
static_assert(sizeof(UStyledBindCaptureButton_C) == 0x000308, "Wrong size on UStyledBindCaptureButton_C");
static_assert(offsetof(UStyledBindCaptureButton_C, UberGraphFrame) == 0x0002F0, "Member 'UStyledBindCaptureButton_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(UStyledBindCaptureButton_C, Button_0) == 0x0002F8, "Member 'UStyledBindCaptureButton_C::Button_0' has a wrong offset!");
static_assert(offsetof(UStyledBindCaptureButton_C, Content) == 0x000300, "Member 'UStyledBindCaptureButton_C::Content' has a wrong offset!");
