...
public:
	...
	float                                         K2Node_VariableSet_LowPassFilterFrequency_ImplicitCast; // 0x0064(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(offsetof(Close_Thunder_Audio_Player_C_ExecuteUbergraph_Close_Thunder_Audio_Player, K2Node_VariableSet_LowPassFilterFrequency_ImplicitCast) == 0x000064, "Member 'Close_Thunder_Audio_Player_C_ExecuteUbergraph_Close_Thunder_Audio_Player::K2Node_VariableSet_LowPassFilterFrequency_ImplicitCast' has a wrong offset!");
