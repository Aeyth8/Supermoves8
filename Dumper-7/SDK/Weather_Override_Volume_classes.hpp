...
// 0x0320 (0x05B8 - 0x0298)
class AWeather_Override_Volume_C final : public AActor
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame;                                    // 0x0298(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
	class UUDW_Lightning_Spawn_Manager_C*         Lightning_Spawn_Manager;                           // 0x02A0(0x0008)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)
	...
	class AUltra_Dynamic_Weather_C*               UDW;                                               // 0x02F8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, Transient, DisableEditOnInstance, NoDestructor, HasGetValueTypeHash)
	...
	class UUDS_Weather_Settings_C*                Editor_Preview_State;                              // 0x0448(0x0008)(Edit, BlueprintVisible, ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	bool                                          Apply_Temperature_Ranges;                          // 0x0569(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_56A[0x6];                                      // 0x056A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	struct FVector2D                              Summer_Temperature_Min_and_Max;                    // 0x0570(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	struct FVector2D                              Autumn_Temperature_Min_and_Max;                    // 0x0580(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	struct FVector2D                              Winter_Temperature_Min_and_Max;                    // 0x0590(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	struct FVector2D                              Spring_Temperature_Min_and_Max;                    // 0x05A0(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, ExposeOnSpawn, HasGetValueTypeHash)
	EUDS_TemperatureType                          Temperature_Scale;                                 // 0x05B0(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(AWeather_Override_Volume_C) == 0x0005B8, "Wrong size on AWeather_Override_Volume_C");
...
static_assert(offsetof(AWeather_Override_Volume_C, Lightning_Spawn_Manager) == 0x0002A0, "Member 'AWeather_Override_Volume_C::Lightning_Spawn_Manager' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Random_Weather_Variation) == 0x0002A8, "Member 'AWeather_Override_Volume_C::Random_Weather_Variation' has a wrong offset!");
...
static_assert(offsetof(AWeather_Override_Volume_C, Mode) == 0x0002C0, "Member 'AWeather_Override_Volume_C::Mode' has a wrong offset!");
...
static_assert(offsetof(AWeather_Override_Volume_C, Weather_Type) == 0x0002D8, "Member 'AWeather_Override_Volume_C::Weather_Type' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Override_Material_Effects) == 0x0002E0, "Member 'AWeather_Override_Volume_C::Override_Material_Effects' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Volume_Alpha) == 0x0002E8, "Member 'AWeather_Override_Volume_C::Volume_Alpha' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Scaled_Transition_Width) == 0x0002F0, "Member 'AWeather_Override_Volume_C::Scaled_Transition_Width' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, UDW) == 0x0002F8, "Member 'AWeather_Override_Volume_C::UDW' has a wrong offset!");
...
static_assert(offsetof(AWeather_Override_Volume_C, Editor_Preview_State) == 0x000448, "Member 'AWeather_Override_Volume_C::Editor_Preview_State' has a wrong offset!");
...
static_assert(offsetof(AWeather_Override_Volume_C, Weather_State) == 0x000478, "Member 'AWeather_Override_Volume_C::Weather_State' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, World_Space_Triangles) == 0x000480, "Member 'AWeather_Override_Volume_C::World_Space_Triangles' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Canvas_Scale_Factor) == 0x000490, "Member 'AWeather_Override_Volume_C::Canvas_Scale_Factor' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Canvas_Offset) == 0x0004A8, "Member 'AWeather_Override_Volume_C::Canvas_Offset' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Volume_Color) == 0x0004C0, "Member 'AWeather_Override_Volume_C::Volume_Color' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Canvas_Space_Triangles) == 0x0004D0, "Member 'AWeather_Override_Volume_C::Canvas_Space_Triangles' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Started) == 0x0004E0, "Member 'AWeather_Override_Volume_C::Started' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Material_State_Buffer) == 0x0004E8, "Member 'AWeather_Override_Volume_C::Material_State_Buffer' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Transitioning_Weather) == 0x000500, "Member 'AWeather_Override_Volume_C::Transitioning_Weather' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Transition_Weather_A) == 0x000508, "Member 'AWeather_Override_Volume_C::Transition_Weather_A' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Transition_Weather_B) == 0x000510, "Member 'AWeather_Override_Volume_C::Transition_Weather_B' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Transition_Time_Remaining) == 0x000518, "Member 'AWeather_Override_Volume_C::Transition_Time_Remaining' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Changing_to_Random_Weather) == 0x000520, "Member 'AWeather_Override_Volume_C::Changing_to_Random_Weather' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Changing_from_Random_Weather) == 0x000521, "Member 'AWeather_Override_Volume_C::Changing_from_Random_Weather' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Transition_Timer_Length) == 0x000528, "Member 'AWeather_Override_Volume_C::Transition_Timer_Length' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Random_Weather_Label_Text) == 0x000530, "Member 'AWeather_Override_Volume_C::Random_Weather_Label_Text' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Runtime_Spline_Points) == 0x000540, "Member 'AWeather_Override_Volume_C::Runtime_Spline_Points' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Preview_Weather_State) == 0x000550, "Member 'AWeather_Override_Volume_C::Preview_Weather_State' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Apply_Wind_Direction) == 0x000558, "Member 'AWeather_Override_Volume_C::Apply_Wind_Direction' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Wind_Direction) == 0x000560, "Member 'AWeather_Override_Volume_C::Wind_Direction' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Applied_Last_Update) == 0x000568, "Member 'AWeather_Override_Volume_C::Applied_Last_Update' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Apply_Temperature_Ranges) == 0x000569, "Member 'AWeather_Override_Volume_C::Apply_Temperature_Ranges' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Summer_Temperature_Min_and_Max) == 0x000570, "Member 'AWeather_Override_Volume_C::Summer_Temperature_Min_and_Max' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Autumn_Temperature_Min_and_Max) == 0x000580, "Member 'AWeather_Override_Volume_C::Autumn_Temperature_Min_and_Max' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Winter_Temperature_Min_and_Max) == 0x000590, "Member 'AWeather_Override_Volume_C::Winter_Temperature_Min_and_Max' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Spring_Temperature_Min_and_Max) == 0x0005A0, "Member 'AWeather_Override_Volume_C::Spring_Temperature_Min_and_Max' has a wrong offset!");
static_assert(offsetof(AWeather_Override_Volume_C, Temperature_Scale) == 0x0005B0, "Member 'AWeather_Override_Volume_C::Temperature_Scale' has a wrong offset!");
