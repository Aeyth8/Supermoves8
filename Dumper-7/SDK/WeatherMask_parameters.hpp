...
// Function WeatherMask.WeatherMask_C.Approximate Masking At Location
// 0x0030 (0x0030 - 0x0000)
struct WeatherMask_C_Approximate_Masking_At_Location final
{
public:
...
static_assert(alignof(WeatherMask_C_Approximate_Masking_At_Location) == 0x000008, "Wrong alignment on WeatherMask_C_Approximate_Masking_At_Location");
static_assert(sizeof(WeatherMask_C_Approximate_Masking_At_Location) == 0x000030, "Wrong size on WeatherMask_C_Approximate_Masking_At_Location");
static_assert(offsetof(WeatherMask_C_Approximate_Masking_At_Location, Location) == 0x000000, "Member 'WeatherMask_C_Approximate_Masking_At_Location::Location' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Approximate_Masking_At_Location, Mode) == 0x000018, "Member 'WeatherMask_C_Approximate_Masking_At_Location::Mode' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Approximate_Masking_At_Location, Mask) == 0x000020, "Member 'WeatherMask_C_Approximate_Masking_At_Location::Mask' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Approximate_Masking_At_Location, Cancel_All_Masks) == 0x000028, "Member 'WeatherMask_C_Approximate_Masking_At_Location::Cancel_All_Masks' has a wrong offset!");
...
static_assert(offsetof(WeatherMask_C_Force_Update, CallFunc_GetActorOfClass_ReturnValue) == 0x000000, "Member 'WeatherMask_C_Force_Update::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Force_Update, CallFunc_IsValid_ReturnValue) == 0x000008, "Member 'WeatherMask_C_Force_Update::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(sizeof(WeatherMask_C_Editor_Update) == 0x000038, "Wrong size on WeatherMask_C_Editor_Update");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_IsPackagedForDistribution_ReturnValue) == 0x000000, "Member 'WeatherMask_C_Editor_Update::CallFunc_IsPackagedForDistribution_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_K2_GetComponentLocation_ReturnValue) == 0x000008, "Member 'WeatherMask_C_Editor_Update::CallFunc_K2_GetComponentLocation_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_Not_PreBool_ReturnValue) == 0x000020, "Member 'WeatherMask_C_Editor_Update::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_GetActorOfClass_ReturnValue) == 0x000028, "Member 'WeatherMask_C_Editor_Update::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_IsValid_ReturnValue) == 0x000030, "Member 'WeatherMask_C_Editor_Update::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_Not_PreBool_ReturnValue_1) == 0x000031, "Member 'WeatherMask_C_Editor_Update::CallFunc_Not_PreBool_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_Not_PreBool_ReturnValue_2) == 0x000032, "Member 'WeatherMask_C_Editor_Update::CallFunc_Not_PreBool_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_Editor_Update, CallFunc_BooleanAND_ReturnValue) == 0x000033, "Member 'WeatherMask_C_Editor_Update::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
...
public:
	...
	bool                                          CallFunc_Component_Generally_In_Range_ReturnValue; // 0x0012(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(WeatherMask_C_ExecuteUbergraph_WeatherMask, CallFunc_Component_Generally_In_Range_ReturnValue) == 0x000012, "Member 'WeatherMask_C_ExecuteUbergraph_WeatherMask::CallFunc_Component_Generally_In_Range_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_ExecuteUbergraph_WeatherMask, CallFunc_BooleanAND_ReturnValue) == 0x000013, "Member 'WeatherMask_C_ExecuteUbergraph_WeatherMask::CallFunc_BooleanAND_ReturnValue' has a wrong offset!");
static_assert(offsetof(WeatherMask_C_ExecuteUbergraph_WeatherMask, CallFunc_BooleanAND_ReturnValue_1) == 0x000014, "Member 'WeatherMask_C_ExecuteUbergraph_WeatherMask::CallFunc_BooleanAND_ReturnValue_1' has a wrong offset!");
...
static_assert(offsetof(WeatherMask_C_ExecuteUbergraph_WeatherMask, CallFunc_Array_Contains_ReturnValue_1) == 0x000029, "Member 'WeatherMask_C_ExecuteUbergraph_WeatherMask::CallFunc_Array_Contains_ReturnValue_1' has a wrong offset!");
