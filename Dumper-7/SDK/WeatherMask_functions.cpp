...
void UWeatherMask_C::Approximate_Masking_At_Location(const struct FVector& Location, EUDS_DLWE_Mode Mode, double* Mask, bool* Cancel_All_Masks)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("WeatherMask_C", "Approximate Masking At Location");

	Params::WeatherMask_C_Approximate_Masking_At_Location Parms{};
