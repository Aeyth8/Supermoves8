...
// (Public, HasOutParams, BlueprintCallable, BlueprintEvent)
// Parameters:
// double                                  Intended_Cloud_Wind_Speed                              (Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void IUltra_Dynamic_Weather_Interface_C::Get_Intended_Cloud_Wind_Speed(double* Intended_Cloud_Wind_Speed)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Ultra_Dynamic_Weather_Interface_C", "Get Intended Cloud Wind Speed");

	Params::Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed Parms{};

	UObject::ProcessEvent(Func, &Parms);

	if (Intended_Cloud_Wind_Speed != nullptr)
		*Intended_Cloud_Wind_Speed = Parms.Intended_Cloud_Wind_Speed;
}
