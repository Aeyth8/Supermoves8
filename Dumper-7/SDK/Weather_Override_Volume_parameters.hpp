...
static_assert(sizeof(Weather_Override_Volume_C_Change_to_Random_Weather_Variation) == 0x000008, "Wrong size on Weather_Override_Volume_C_Change_to_Random_Weather_Variation");
...
{
public:
	class AUltra_Dynamic_Weather_C*               Weather;                                           // 0x0000(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnTemplate, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Convert_Temperature_Scale_Output;         // 0x0018(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Convert_Temperature_Scale_Output_2;       // 0x0048(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Convert_Temperature_Scale_Output_3;       // 0x0050(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Convert_Temperature_Scale_Output_4;       // 0x0078(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        CallFunc_Convert_Temperature_Scale_Output_5;       // 0x0080(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_Convert_Temperature_Scale_Output_6;       // 0x00A8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	uint8                                         Pad_B1[0x7];                                       // 0x00B1(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
	double                                        CallFunc_Convert_Temperature_Scale_Output_7;       // 0x00B8(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale) == 0x0000E0, "Wrong size on Weather_Override_Volume_C_Check_to_Update_Temperature_Scale");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, Weather) == 0x000000, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::Weather' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_X) == 0x000008, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_X' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_Y) == 0x000010, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_Y' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output) == 0x000018, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output_1) == 0x000020, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_MakeVector2D_ReturnValue) == 0x000028, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_MakeVector2D_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_X_1) == 0x000038, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_X_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_Y_1) == 0x000040, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_Y_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output_2) == 0x000048, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output_3) == 0x000050, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output_3' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_MakeVector2D_ReturnValue_1) == 0x000058, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_MakeVector2D_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_X_2) == 0x000068, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_X_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_Y_2) == 0x000070, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_Y_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output_4) == 0x000078, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output_4' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output_5) == 0x000080, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output_5' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_MakeVector2D_ReturnValue_2) == 0x000088, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_MakeVector2D_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_X_3) == 0x000098, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_X_3' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_BreakVector2D_Y_3) == 0x0000A0, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_BreakVector2D_Y_3' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output_6) == 0x0000A8, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output_6' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_NotEqual_ByteByte_ReturnValue) == 0x0000B0, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_NotEqual_ByteByte_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_Convert_Temperature_Scale_Output_7) == 0x0000B8, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_Convert_Temperature_Scale_Output_7' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_MakeVector2D_ReturnValue_3) == 0x0000C0, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_MakeVector2D_ReturnValue_3' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_GetActorOfClass_ReturnValue) == 0x0000D0, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Check_to_Update_Temperature_Scale, CallFunc_IsValid_ReturnValue) == 0x0000D8, "Member 'Weather_Override_Volume_C_Check_to_Update_Temperature_Scale::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
public:
	...
	EEndPlayReason                                K2Node_Event_EndPlayReason;                        // 0x003B(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3C[0x4];                                       // 0x003C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<EEndPlayReason>                        K2Node_MakeArray_Array;                            // 0x0040(0x0010)(ConstParm, ReferenceParm)
	...
	class UUDS_Weather_Settings_C*                K2Node_Select_Default;                             // 0x0078(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	class UUDS_Weather_Settings_C*                K2Node_Select_Default_1;                           // 0x0080(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
	...
	double                                        CallFunc_FMax_ReturnValue_2;                       // 0x00A0(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TDelegate<void(class AActor* Actor, EEndPlayReason EndPlayReason)> K2Node_CreateDelegate_OutputDelegate;              // 0x00B4(0x0010)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
};
...
static_assert(sizeof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume) == 0x0000C8, "Wrong size on Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_EqualEqual_ByteByte_ReturnValue) == 0x000004, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_EqualEqual_ByteByte_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_CustomEvent_New_Weather_Type) == 0x000010, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_CustomEvent_New_Weather_Type' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_CustomEvent_Time_To_Transition_To_New_Weather__Seconds_) == 0x000018, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_CustomEvent_Time_To_Transition_To_New_Weather__Seconds_' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsComponentTickEnabled_ReturnValue) == 0x000030, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsComponentTickEnabled_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Not_PreBool_ReturnValue) == 0x000031, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, Temp_bool_Variable) == 0x000032, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::Temp_bool_Variable' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_Event_DeltaSeconds) == 0x000034, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_Event_DeltaSeconds' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_EqualEqual_ByteByte_ReturnValue_1) == 0x000038, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_EqualEqual_ByteByte_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_HasAuthority_ReturnValue) == 0x000039, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsValid_ReturnValue) == 0x00003A, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsValid_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_Event_EndPlayReason) == 0x00003B, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_Event_EndPlayReason' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_MakeArray_Array) == 0x000040, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_MakeArray_Array' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Array_Contains_ReturnValue) == 0x000050, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Array_Contains_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, Temp_bool_Variable_1) == 0x000051, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::Temp_bool_Variable_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_GetWorldDeltaSeconds_ReturnValue) == 0x000058, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_GetWorldDeltaSeconds_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_SafeDivide_ReturnValue) == 0x000060, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_SafeDivide_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Subtract_DoubleDouble_ReturnValue) == 0x000068, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Subtract_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_LessEqual_DoubleDouble_ReturnValue) == 0x000070, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_LessEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_HasAuthority_ReturnValue_1) == 0x000071, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_HasAuthority_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_SwitchEnum_CmpSuccess) == 0x000072, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_Select_Default) == 0x000078, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_Select_Default_1) == 0x000080, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_Select_Default_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Greater_DoubleDouble_ReturnValue) == 0x000088, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Greater_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Array_RemoveItem_ReturnValue) == 0x000089, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Array_RemoveItem_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Multiply_DoubleDouble_ReturnValue) == 0x000090, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Multiply_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_Subtract_DoubleDouble_ReturnValue_1) == 0x000098, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_Subtract_DoubleDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_FMax_ReturnValue_2) == 0x0000A0, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_FMax_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_GetActorOfClass_ReturnValue) == 0x0000A8, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_GetActorOfClass_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_IsValid_ReturnValue_1) == 0x0000B0, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_IsValid_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, CallFunc_EqualEqual_DoubleDouble_ReturnValue) == 0x0000B1, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::CallFunc_EqualEqual_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume, K2Node_CreateDelegate_OutputDelegate) == 0x0000B4, "Member 'Weather_Override_Volume_C_ExecuteUbergraph_Weather_Override_Volume::K2Node_CreateDelegate_OutputDelegate' has a wrong offset!");
...
// 0x0001 (0x0001 - 0x0000)
struct Weather_Override_Volume_C_Reset_to_Editor_Weather final
{
public:
	bool                                          CallFunc_IsValid_ReturnValue;                      // 0x0000(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Weather_Override_Volume_C_Reset_to_Editor_Weather) == 0x000001, "Wrong alignment on Weather_Override_Volume_C_Reset_to_Editor_Weather");
static_assert(sizeof(Weather_Override_Volume_C_Reset_to_Editor_Weather) == 0x000001, "Wrong size on Weather_Override_Volume_C_Reset_to_Editor_Weather");
static_assert(offsetof(Weather_Override_Volume_C_Reset_to_Editor_Weather, CallFunc_IsValid_ReturnValue) == 0x000000, "Member 'Weather_Override_Volume_C_Reset_to_Editor_Weather::CallFunc_IsValid_ReturnValue' has a wrong offset!");
...
static_assert(alignof(Weather_Override_Volume_C_Start_Up_Lightning_Spawner) == 0x000001, "Wrong alignment on Weather_Override_Volume_C_Start_Up_Lightning_Spawner");
static_assert(sizeof(Weather_Override_Volume_C_Start_Up_Lightning_Spawner) == 0x000001, "Wrong size on Weather_Override_Volume_C_Start_Up_Lightning_Spawner");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_Lightning_Spawner, CallFunc_HasAuthority_ReturnValue) == 0x000000, "Member 'Weather_Override_Volume_C_Start_Up_Lightning_Spawner::CallFunc_HasAuthority_ReturnValue' has a wrong offset!");
...
public:
	...
	EUDS_Weather_Override_Mode                    Temp_byte_Variable;                                // 0x0015(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_16[0x2];                                       // 0x0016(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
	class UUDS_Weather_Settings_C*                CallFunc_SpawnObject_ReturnValue_1;                // 0x0018(0x0008)(ZeroConstructor, NoDestructor, HasGetValueTypeHash)
...
static_assert(alignof(Weather_Override_Volume_C_Start_Up_WOV) == 0x000008, "Wrong alignment on Weather_Override_Volume_C_Start_Up_WOV");
static_assert(sizeof(Weather_Override_Volume_C_Start_Up_WOV) == 0x000048, "Wrong size on Weather_Override_Volume_C_Start_Up_WOV");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, CallFunc_Not_PreBool_ReturnValue) == 0x000000, "Member 'Weather_Override_Volume_C_Start_Up_WOV::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, CallFunc_SpawnObject_ReturnValue) == 0x000008, "Member 'Weather_Override_Volume_C_Start_Up_WOV::CallFunc_SpawnObject_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, CallFunc_Array_Length_ReturnValue) == 0x000010, "Member 'Weather_Override_Volume_C_Start_Up_WOV::CallFunc_Array_Length_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, CallFunc_Greater_IntInt_ReturnValue) == 0x000014, "Member 'Weather_Override_Volume_C_Start_Up_WOV::CallFunc_Greater_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, Temp_byte_Variable) == 0x000015, "Member 'Weather_Override_Volume_C_Start_Up_WOV::Temp_byte_Variable' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, CallFunc_SpawnObject_ReturnValue_1) == 0x000018, "Member 'Weather_Override_Volume_C_Start_Up_WOV::CallFunc_SpawnObject_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, K2Node_Select_Default) == 0x000020, "Member 'Weather_Override_Volume_C_Start_Up_WOV::K2Node_Select_Default' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, CallFunc_MakeVector_ReturnValue) == 0x000028, "Member 'Weather_Override_Volume_C_Start_Up_WOV::CallFunc_MakeVector_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_Start_Up_WOV, K2Node_SwitchEnum_CmpSuccess) == 0x000040, "Member 'Weather_Override_Volume_C_Start_Up_WOV::K2Node_SwitchEnum_CmpSuccess' has a wrong offset!");
...
public:
	...
	class FString                                 K2Node_Select_Default_2;                           // 0x0160(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	float                                         CallFunc_HSVToRGB_H_ImplicitCast;                  // 0x02D8(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_HSVToRGB_H_ImplicitCast_1;                // 0x02DC(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         CallFunc_SetWorldSize_Value_ImplicitCast;          // 0x02E0(0x0004)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(sizeof(Weather_Override_Volume_C_UserConstructionScript) == 0x000300, "Wrong size on Weather_Override_Volume_C_UserConstructionScript");
...
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Conv_LinearColorToColor_ReturnValue) == 0x0000C0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Conv_LinearColorToColor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Len_ReturnValue) == 0x0000C4, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Len_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Conv_IntToDouble_ReturnValue) == 0x0000C8, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Conv_IntToDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_FMax_ReturnValue) == 0x0000D0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_FMax_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Divide_DoubleDouble_ReturnValue) == 0x0000D8, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Divide_DoubleDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_IsPackagedForDistribution_ReturnValue) == 0x0000E0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_IsPackagedForDistribution_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Not_PreBool_ReturnValue) == 0x0000E1, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Not_PreBool_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Conv_StringToText_ReturnValue) == 0x0000E8, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Conv_StringToText_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_GetActorScale3D_ReturnValue) == 0x000100, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_GetActorScale3D_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Divide_VectorVector_ReturnValue) == 0x000118, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Divide_VectorVector_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_GetDisplayName_ReturnValue) == 0x000138, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_GetDisplayName_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Divide_DoubleDouble_ReturnValue_2) == 0x000148, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Divide_DoubleDouble_ReturnValue_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Replace_ReturnValue) == 0x000150, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Replace_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, K2Node_Select_Default_2) == 0x000160, "Member 'Weather_Override_Volume_C_UserConstructionScript::K2Node_Select_Default_2' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_GetSplineLength_ReturnValue) == 0x000170, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_GetSplineLength_ReturnValue' has a wrong offset!");
...
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_FFloor_ReturnValue) == 0x000180, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_FFloor_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Conv_IntToDouble_ReturnValue_1) == 0x000188, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Conv_IntToDouble_ReturnValue_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_LessEqual_IntInt_ReturnValue) == 0x000190, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_LessEqual_IntInt_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Divide_DoubleDouble_ReturnValue_4) == 0x000198, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Divide_DoubleDouble_ReturnValue_4' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Multiply_IntFloat_ReturnValue) == 0x0001A0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Multiply_IntFloat_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_GetTransformAtDistanceAlongSpline_ReturnValue) == 0x0001B0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_GetTransformAtDistanceAlongSpline_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_BreakTransform_Location) == 0x000210, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_BreakTransform_Location' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_BreakTransform_Rotation) == 0x000228, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_BreakTransform_Rotation' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_BreakTransform_Scale) == 0x000240, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_BreakTransform_Scale' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_ComposeRotators_ReturnValue) == 0x000258, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_ComposeRotators_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_MakeTransform_ReturnValue) == 0x000270, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_MakeTransform_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_AddComponent_ReturnValue) == 0x0002D0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_AddComponent_ReturnValue' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_HSVToRGB_H_ImplicitCast) == 0x0002D8, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_HSVToRGB_H_ImplicitCast' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_HSVToRGB_H_ImplicitCast_1) == 0x0002DC, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_HSVToRGB_H_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_SetWorldSize_Value_ImplicitCast) == 0x0002E0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_SetWorldSize_Value_ImplicitCast' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Divide_DoubleDouble_A_ImplicitCast) == 0x0002E8, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Divide_DoubleDouble_A_ImplicitCast' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_Divide_DoubleDouble_A_ImplicitCast_1) == 0x0002F0, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_Divide_DoubleDouble_A_ImplicitCast_1' has a wrong offset!");
static_assert(offsetof(Weather_Override_Volume_C_UserConstructionScript, CallFunc_GetTransformAtDistanceAlongSpline_Distance_ImplicitCast) == 0x0002F8, "Member 'Weather_Override_Volume_C_UserConstructionScript::CallFunc_GetTransformAtDistanceAlongSpline_Distance_ImplicitCast' has a wrong offset!");
