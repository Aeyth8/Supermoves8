...
static_assert(sizeof(UClose_Thunder_Audio_Player_C) == 0x0002F0, "Wrong size on UClose_Thunder_Audio_Player_C");
...
static_assert(offsetof(UClose_Thunder_Audio_Player_C, Allow_Spatialization) == 0x0002E0, "Member 'UClose_Thunder_Audio_Player_C::Allow_Spatialization' has a wrong offset!");
