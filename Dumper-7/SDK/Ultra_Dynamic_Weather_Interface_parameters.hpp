...
static_assert(sizeof(Ultra_Dynamic_Weather_Interface_C_Apply_State) == 0x000160, "Wrong size on Ultra_Dynamic_Weather_Interface_C_Apply_State");
...
// Function Ultra_Dynamic_Weather_Interface.Ultra_Dynamic_Weather_Interface_C.Get Intended Cloud Wind Speed
// 0x0008 (0x0008 - 0x0000)
struct Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed final
{
public:
	double                                        Intended_Cloud_Wind_Speed;                         // 0x0000(0x0008)(Parm, OutParm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
static_assert(alignof(Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed) == 0x000008, "Wrong alignment on Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed");
static_assert(sizeof(Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed) == 0x000008, "Wrong size on Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed");
static_assert(offsetof(Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed, Intended_Cloud_Wind_Speed) == 0x000000, "Member 'Ultra_Dynamic_Weather_Interface_C_Get_Intended_Cloud_Wind_Speed::Intended_Cloud_Wind_Speed' has a wrong offset!");
...
static_assert(sizeof(Ultra_Dynamic_Weather_Interface_C_Get_State_for_Saving) == 0x000160, "Wrong size on Ultra_Dynamic_Weather_Interface_C_Get_State_for_Saving");
