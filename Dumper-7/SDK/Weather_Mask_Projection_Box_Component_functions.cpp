...
void UWeather_Mask_Projection_Box_Component_C::Approximate_Masking_At_Location(const struct FVector& Location, EUDS_DLWE_Mode Mode, double* Mask, bool* Cancel_All_Masks)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Weather_Mask_Projection_Box_Component_C", "Approximate Masking At Location");

	Params::Weather_Mask_Projection_Box_Component_C_Approximate_Masking_At_Location Parms{};
